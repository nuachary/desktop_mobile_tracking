...
if __name__ == "__main__":
    conn = sqlite3.connect('C:\\Users\\HP\\Documents\\Privacy\\Privacy-Project\\crawl-data.sqlite')
    cur = conn.cursor() 
    ...
    df_cookie_data.to_csv('C:\\Users\\HP\\Documents\\Privacy\\Privacy-Project\\Social_Media_crawl_cookie.csv',sep=',')
